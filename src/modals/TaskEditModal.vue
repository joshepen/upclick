...
const title = ref(dialogRef.value.data ? dialogRef.value.data.task?.title : '')
const description = ref(dialogRef.value.data ? dialogRef.value.data.task?.description : '')
const deadline = ref(dialogRef.value.data ? (dialogRef.value.data.task ? dialogRef.value.data.task.deadline : new Date()) : new Date())
